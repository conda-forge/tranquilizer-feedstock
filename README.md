About tranquilizer-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tranquilizer-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6343&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tranquilizer-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tranquilizer` can be installed with `conda`:
...
```
mamba install tranquilizer
```

It is possible to list all of the versions of `tranquilizer` available on your platform with `conda`:
...
```
mamba search tranquilizer --channel conda-forge
```
...
mamba repoquery search tranquilizer --channel conda-forge

# List packages depending on `tranquilizer`:
mamba repoquery whoneeds tranquilizer --channel conda-forge

# List dependencies of `tranquilizer`:
mamba repoquery depends tranquilizer --channel conda-forge
```
